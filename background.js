...
chrome.webNavigation.onBeforeNavigate.addListener((details) => {
  ...
  if (details.frameId === 0) {
    ...
    if ((urlObj.hostname.includes("conteudo.cbf.com.br") && urlObj.pathname.includes("/sumulas/")) ||
        ...
        (urlObj.hostname.includes("fpfpara.com.br") && urlObj.pathname.includes("/files/sumulas/")) ||
        (urlObj.hostname.includes("federacaopr.com.br") && urlObj.pathname.includes("/download/sumula"))) {
  ...
  url: [
    ...
    { hostContains: "fpfpara.com.br", pathContains: "/files/sumulas/" },
    { hostContains: "federacaopr.com.br", pathContains: "/download/sumula" }
  ] 
});
